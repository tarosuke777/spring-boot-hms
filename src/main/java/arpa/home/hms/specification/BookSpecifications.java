...
import arpa.home.hms.entity.AuthorEntity_;
import arpa.home.hms.entity.BookEntity;
import arpa.home.hms.entity.BookEntity_;
...
public class BookSpecifications {
  ...
  public static Specification<BookEntity> withFilters(Integer userId, BookGenre genre,
    ...
    return (root, query, cb) -> {
      ...
      if (authorId != null) {
        predicates.add(cb.equal(root.get(BookEntity_.author).get(AuthorEntity_.id), authorId));
      }
